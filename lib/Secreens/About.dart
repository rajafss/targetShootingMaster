...
import 'Calendar/calendar.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        title: Center(child: new Text('About Coach', style: TextStyle(color: Colors.white,fontSize: 30),)),
      ),
      body: Padding(
          ...
          children:[
            ...
            new Container(
              ...
              child: Column(
                ...
                children: [
                  new Center(
                    child: Text('MOUADH',style: TextStyle(color: Colors.amberAccent.shade100,fontSize: 30)),
                  ),
                  SizedBox(
                    height: 30,
                  ),
                  new Text('He love shooting and puts a tremendous amount of effort into making sure he fulfil his dreams of achievement.',
